  ...
  app.delete(
    ...
    async ({ params, set }) => {
      try {
        ...
        const result = await deps.ProductService.onDelete(id)
        if (!result)
          throw NewError("Failed to Delete Product Not Found", "Delete_FAILED", 404)
      ...
      detail: {
        ...
        responses: {
          200: {
            ...
            description: "Product Delete data success",
          },
          404: {
            content: {
              "application/json": {
          ...
          500: {
            ...
            description: "Product Delete data fail",
          },
        },
        tags: ["Product"],
      },
