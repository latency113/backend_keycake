...
import { TeamUpdateOneWithoutOrdersNestedInputSchema } from "./TeamUpdateOneWithoutOrdersNestedInputSchema"
...
export default OrderUpdateWithoutClassroomInputSchema
